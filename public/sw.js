...
const CORE=[
'./','./index.html','./styles.css','./styles-responsive.css','./app.js',
'./lib/db.js','./lib/adaptive.js','./lib/audio.js','./lib/sync.js','./lib/curriculum.js','./lib/session.js',
'./lib/ui-shell.js','./lib/ui-today.js','./lib/ui-learn.js','./lib/ui-progress.js','./lib/analytics.js',
'./manifest.webmanifest','./content/content.json','./assets/icon.svg'
];
...
self.addEventListener('fetch',event=>{
 ...
 if(req.mode==='navigate'){event.respondWith((async()=>{try{const net=await fetch(req);const c=await caches.open(CACHE);c.put('./index.html',net.clone());return net}catch{return await caches.match('./index.html')||await caches.match('./')}})());return}
