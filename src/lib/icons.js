...
export const themeGlyph=id=>({survival:'✦',identity:'☺',numbers:'123',colors:'◐',food:'☕',hotel:'⌂',travel:'✈',shopping:'▢',smalltalk:'◌',work:'▣',idioms:'“”',phrasal:'↔',collocations:'⛓',pronunciation:'≋',falsefriends:'!','time-basics':'◷','family-home':'⌂',emergency:'✚','grammar-a1':'Aa','daily-life':'☀','travel-a1':'✈','health-a1':'✚','grammar-a2':'Aa','social-a2':'◌','travel-a2':'✈','work-a2':'▣'}[id]||'•');
