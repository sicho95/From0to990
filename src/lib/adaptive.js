...
'general.survival':'Survie','general.identity':'Se présenter','general.numbers':'Nombres','general.hotel':'Hôtel','general.travel':'Voyage','general.grammar':'Grammaire générale',
'general.politeness':'Politesse','general.collocations':'Collocations','general.paraphrase':'Paraphrases','general.idioms':'Idiomes','general.nuance':'Nuance',
'general.food':'Restaurant & repas','general.colors':'Couleurs','general.shopping':'Achats','general.smalltalk':'Small talk','general.work':'Anglais professionnel','general.pronunciation':'Compréhension orale naturelle'
};
...
const priorityScore=s=>(1-(s.mastery??.5))*(.65+.35*Math.min(1,(s.attempts||0)/8));
...
export function estimatedScores(questions,attempts){
 ...
 const toeic=attempts.filter(a=>{const q=qmap.get(a.questionId);return q&&Number.isInteger(q.part)&&q.part>=1&&q.part<=7&&q.domain!=='general'}).slice(-200);
